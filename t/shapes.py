...
class TestShapes(unittest.TestCase):
  ...
  def test_0(self):
    ...
    shape = self.lt.foreground(0, 0, self.data['a'])
  ...
  def test_1(self):
    ...
    self.lt.cellsize = 3
    self.assertRaises(ValueError, self.lt.foreground, 0, 0, self.data['d'])
  ...
  def test_2(self):
    ...
    self.lt.cellsize = 24
    sq = self.lt.foreground(0, 0, self.data['c'])
    '''
  ...
  def test_3(self):
    ...
    for i, scale in enumerate([0.5, 0.75, 1.0, 1.5, 2.0]):
      ...
      self.data['a']['stroke_width'] = 5
      fg = lt.foreground(0, 0, self.data['a'])
