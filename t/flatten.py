...
class TestFlatten(unittest.TestCase):
  ...
  def test_0(self):
    ...
    r = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    r.meander()
    #r.printPoints()
  ...
  def test_1(self):
    ...
    r = Rectangle(coordinates=(0, 0), dimensions=(3, 3), direction='E')
    r.meander()
    self.assertEqual(expect, r.xyPoints())
  def test_2(self):
    ''' north rectangle
    ...
    r = Rectangle(coordinates=(3, 1), dimensions=(5, 2))
    r.meander()
    self.assertEqual(len(expect[0]), len(r.xyPoints()[0]))
    self.assertEqual(expect, r.xyPoints())
  def test_3(self):
    ...
    r = Rectangle(coordinates=(3, 1), dimensions=(5, 2), direction='E')
    r.meander()
    self.assertEqual(expect, r.xyPoints())
  def test_4(self):
    ...
    r = Rectangle(coordinates=(3, 1), dimensions=(8, 13), direction='N')
    r.meander(gap=3)
    self.assertEqual(expect, r.xyPoints())
  def test_5(self):
    ...
    r = Rectangle(coordinates=(3, 1), dimensions=(8, 13), direction='E')
    r.meander(gap=3)
    self.assertEqual(len(expect[0]), len(r.xyPoints()[0]))
    self.assertEqual(expect, r.xyPoints())
  # Overlay tests
  def test_6(self):
    ...
    count, d = self.f.overlayTwoCells(
      Rectangle(coordinates=(0, 0), dimensions=(4, 4)),
      Rectangle(coordinates=(1, 1), dimensions=(2, 2))
    )
  ...
  def test_7(self):
    ...
    '''
    expect = 3
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    upper = [
      Rectangle(coordinates=(-2,  1), dimensions=(3, 1)),
      Rectangle(coordinates=( 1,  2), dimensions=(1, 3)),
      Rectangle(coordinates=( 2,  1), dimensions=(3, 1)),
      Rectangle(coordinates=( 1, -2), dimensions=(1, 3))
    ]
    for u in upper:
  ...
  def test_8(self):
    ...
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    upper = [
      Rectangle(coordinates=(-1,  1), dimensions=(5, 1)),
      Rectangle(coordinates=( 1, -1), dimensions=(1, 5))
    ]
    for u in upper:
      count, d = self.f.overlayTwoCells(lower, u)
      self.assertEqual(expect, count)
  def test_9(self):
    ...
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    upper = [
      Rectangle(coordinates=(-2, -2), dimensions=(3, 3)),
      Rectangle(coordinates=( 2,  2), dimensions=(3, 3)),
      Rectangle(coordinates=(-2,  2), dimensions=(3, 3)),
      Rectangle(coordinates=( 2, -2), dimensions=(3, 3))
    ]
  ...
  def test_10(self):
    ...
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    upper = [
      Rectangle(coordinates=( 0, -1), dimensions=(3, 3)),
      Rectangle(coordinates=(-1,  0), dimensions=(3, 3)),
      Rectangle(coordinates=( 0,  1), dimensions=(3, 3)),
      Rectangle(coordinates=( 1,  0), dimensions=(3, 3))
    ]
    for u in upper:
  ...
  def test_11(self):
    ...
    '''
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    up = Rectangle(coordinates=(1, 0), dimensions=(3, 3))
    up.compare(lower)
  ...
  def test_12(self):
    ...
    '''
    lower = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    up = Rectangle(coordinates=(0, 4), dimensions=(3, 3))
    up.compare(lower)
  ...
  def test_20(self):
    ...
    lower = Rectangle(coordinates=(1,1), dimensions=(4,4))
    upper = Rectangle(coordinates=(2,2), dimensions=(2,2))
  ...
  def test_21(self):
    ...
    g = Gnomon(coordinates=(1,1), edges={'a':2,'b':50000,'d':None,'c':4}, dimensions=(4,4))
    #g.printPoints()
    g.meander()
  ...
  def test_22(self):
    ...
    #g = Gnomon(coordinates=(2,1), edges={'a':2,'b':4,'c':2,'d':4}, dimensions=(3,3), direction='SE')
  ...
  def test_30(self):
    ...
    p = Parabola(coordinates=(1,1), edges={'a':None,'b':5,'c':5,'d':3}, dimensions=(6,6), direction='W')
    p.meander()
    #p.printPoints()
  ...
  def test_32(self):
    ...
    lo = Rectangle(coordinates=(0, 0), dimensions=(3, 3))
    up = Rectangle(coordinates=(2, 1), dimensions=(3, 1))
    numof_edges, d = self.f.overlayTwoCells(lo, up)
    shapes = self.f.splitLowerUpper(numof_edges, lo, up, direction=d)
    self.assertEqual(shapes[0].xyPoints(), expect)
  def test_33(self):
  ...
  def test_34(self):
    ...
    lo = Rectangle(coordinates=(1, 0), dimensions=(3, 3))
    up = Rectangle(coordinates=(0, 1), dimensions=(2, 1))
    numof_edges, d = self.f.overlayTwoCells(lo, up)
    shapes = self.f.splitLowerUpper(numof_edges, lo, up, direction=d)
